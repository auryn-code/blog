...
export default defineConfig({
  ...
  // [Experimental]
  // Removed outdated experimental flags so this template can run on the
  // Astro version required by the bundled local theme package.
})
